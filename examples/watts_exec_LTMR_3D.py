...
for params['3D'] in [True, False]:
    ...
    if rank ==0:
        ...
        tracked_params_list =     ["Fuel","Fuel Lifetime", "3D","Enrichment","Security","Mass U235", "Mass U238", "Uranium Mass"]

        parametric_studies('/home/garcsamu/OpenMC/MOUSE/cost/Cost_Database.xlsx',  params, tracked_params_list, '/home/garcsamu/OpenMC/TEMA/results/LTMR_3D_comparison.csv')
