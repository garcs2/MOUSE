...
#                                                Sec. 1: Materials
# **************************************************************************************************************************
for params['Fuel'] in ['TRIGA_fuel', 'UO2', 'UC', 'UCO', 'UN']:
    update_params({
    ...
    tracked_params_list =     ["Fuel","Fuel Lifetime", "Enrichment","Mass U235", "Mass U238", "Uranium Mass"]

    parametric_studies('/home/garcsamu/OpenMC/MOUSE/cost/Cost_Database.xlsx',  params, tracked_params_list, '/home/garcsamu/OpenMC/MOUSE/examples/output_parametric_LTMR_fuel_study.csv')
