...
def collect_materials_data(params):
    ...
    homog_heatpipe = openmc.Material(name='homog_heatpipe')
    homog_heatpipe.set_density('atom/b-cm', 2.74917E-02)
    homog_heatpipe.temperature = params['Common Temperature']
    homog_heatpipe.add_nuclide('Si28',  1.49701E-02, 'ao')
    homog_heatpipe.add_nuclide('Si29',  7.60143E-04, 'ao')
    homog_heatpipe.add_nuclide('Si30',  5.01090E-04, 'ao')
    homog_heatpipe.add_nuclide('Cr50',  6.46763E-03, 'ao')
    homog_heatpipe.add_nuclide('Cr52',  1.24724E-01, 'ao')
    homog_heatpipe.add_nuclide('Cr53',  1.41423E-02, 'ao')
    homog_heatpipe.add_nuclide('Cr54',  3.52029E-03, 'ao')
    homog_heatpipe.add_nuclide('Mn55',  1.66133E-02, 'ao')
    homog_heatpipe.add_nuclide('Fe54',  3.12186E-02, 'ao')
    homog_heatpipe.add_nuclide('Fe56',  4.90061E-01, 'ao')
    homog_heatpipe.add_nuclide('Fe57',  1.13180E-02, 'ao')
    homog_heatpipe.add_nuclide('Fe58',  1.50617E-03, 'ao')
    homog_heatpipe.add_nuclide('Ni58',  6.33738E-02, 'ao')
    homog_heatpipe.add_nuclide('Ni60',  2.44119E-02, 'ao')
    homog_heatpipe.add_nuclide('Ni61',  1.06115E-03, 'ao')
    homog_heatpipe.add_nuclide('Ni62',  3.38338E-03, 'ao')
    homog_heatpipe.add_nuclide('Ni64',  8.61654E-04, 'ao')
    homog_heatpipe.add_nuclide('Mo92',  1.75699E-03, 'ao')
    homog_heatpipe.add_nuclide('Mo94',  1.09514E-03, 'ao')
    homog_heatpipe.add_nuclide('Mo95',  1.88484E-03, 'ao')
    homog_heatpipe.add_nuclide('Mo96',  1.97478E-03, 'ao')
    homog_heatpipe.add_nuclide('Mo97',  1.13066E-03, 'ao')
    homog_heatpipe.add_nuclide('Mo98',  2.85681E-03, 'ao')
    homog_heatpipe.add_nuclide('Mo100', 1.14011E-03, 'ao')
    homog_heatpipe.add_nuclide('Na23',  1.79266E-01, 'ao')
   
    materials.append(homog_heatpipe)
    materials_database.update({'homog_heatpipe': homog_heatpipe})
